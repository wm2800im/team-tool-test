const CACHE='covoiturage-4.8.0-beta.3';
const SHELL=['./','./index.html','./styles.css','./app.js','./quota-core.mjs','./public-config.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
